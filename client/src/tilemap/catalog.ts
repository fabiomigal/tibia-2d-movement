...
function batedorRuinasAsset(input: Omit<TileAssetManifestEntry, "sourceUrl" | "author" | "license" | "licenseUrl" | "attributionRequired" | "attributionText">): TileAssetManifestEntry {
  return {
    ...input,
    sourceUrl: AURORA_PROJECT_SOURCE,
    author: "fabiomigal@gmail.com",
    license: "Uso autorizado pelo autor para este projeto",
    licenseUrl: AURORA_PROJECT_SOURCE,
    attributionRequired: false,
...
export const TILE_ASSET_MANIFEST: TileAssetManifestEntry[] = [
  ...
  batedorRuinasAsset({ assetId: "aurora_adventurer", name: "Batedor de Ruínas — Gemini", category: "character", originalFilename: "Gemini_Generated_Image_ypg5w1ypg5w1ypg5.jpg", localFilename: "/manus-storage/batedor-ruinas-idle-4x4_e8c66a18.png", tileWidth: 128, tileHeight: 128, previewColor: "#D49048" }),
