...
export const TILE_ASSET_MANIFEST: TileAssetManifestEntry[] = [
  ...
  batedorRuinasAsset({ assetId: "aurora_adventurer", name: "Batedor de Ruínas — Gemini", category: "character", originalFilename: "Gemini_Generated_Image_ypg5w1ypg5w1ypg5.jpg", localFilename: "/manus-storage/batedor-ruinas-idle-4x4_172055a4.png", tileWidth: 96, tileHeight: 96, previewColor: "#D49048" }),
